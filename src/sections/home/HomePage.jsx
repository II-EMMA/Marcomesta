...
export default async function HomePage() {
  ...
  return (
    <section className="relative z-40 w-screen left-1/2 -translate-x-1/2 bg-white">
      ...
      <div className="flex flex-col max-w-[1500px] mx-auto bg-gradient pt-10 pb-20">
        <div
          className={`z-50 flex lg:flex-row flex-col gap-y-32 lg:gap-y-0 items-center lg:gap-x-2 justify-between mt-10 ${
